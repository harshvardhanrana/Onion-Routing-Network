...
func (m *DummyRequest) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
func (m *DummyResponse) GetReply() []byte {
	if m != nil {
		return m.Reply
	}
	return nil
...
var fileDescriptor_34181ec3bf593d6c = []byte{
	...
	0x53, 0x8b, 0x8b, 0x13, 0xd3, 0x53, 0x25, 0x18, 0x15, 0x18, 0x35, 0x78, 0x82, 0x60, 0x5c, 0x25,
	...
	0x8e, 0x49, 0x6c, 0x60, 0xb6, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xab, 0x17, 0xc0, 0x29, 0x5c,
	0x01, 0x00, 0x00,
}
